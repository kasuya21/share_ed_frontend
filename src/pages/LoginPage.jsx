...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('ยินดีต้อนรับเข้าสู่ระบบ', { position: 'top-center' });
      navigate('/');
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 glass-panel rounded-3xl z-10 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2 tracking-tight">ยินดีต้อนรับกลับมา</h1>
          <p className="text-muted-foreground font-light">เข้าสู่ระบบเพื่อดำเนินการต่อใน Share-ED</p>
        </div>
